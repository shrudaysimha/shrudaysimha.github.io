...
void main() {
    ...
    `,v=new h0(2.2,1),y=v.toNonIndexed(),E=y.attributes.position.count,M=[];for(let H=0;H<E;H+=3)M.push(1,0,0,0,1,0,0,0,1);y.setAttribute("barycentric",new Ri(M,3));const S=new sa({vertexShader:_,fragmentShader:g,uniforms:{uTime:{value:0}},side:_a,transparent:!0}),x=new Ea(y,S);x.position.set(1.8,0,0),a.current=x,f.add(x);const R=new Yi,w=800,C=new Float32Array(w*3);for(let H=0;H<w;H++){const Y=4+Math.random()*2,K=Math.random()*Math.PI*2,ut=Math.acos(2*Math.random()-1);C[H*3]=Y*Math.sin(ut)*Math.cos(K),C[H*3+1]=Y*Math.sin(ut)*Math.sin(K),C[H*3+2]=Y*Math.cos(ut)}R.setAttribute("position",new ra(C,3));const N=new XS({size:.04,color:new ze(2450411),transparent:!0,opacity:.6,sizeAttenuation:!0});l.current=N;const P=new XT(R,N);s.current=P,f.add(P);let O;const I=new KT,T=()=>{O=requestAnimationFrame(T);const H=I.getElapsedTime();S.uniforms.uTime.value=H,a.current&&(a.current.rotation.x=Math.sin(H*.1)*.2,a.current.rotation.y=H*.15,a.current.position.y=Math.sin(H*.5)*.1),s.current&&(s.current.rotation.y=-H*.05,s.current.rotation.x=Math.sin(H*.05)*.1),d.render(f,p)};T();const L=()=>{p.aspect=window.innerWidth/window.innerHeight,p.updateProjectionMatrix(),d.setSize(window.innerWidth,window.innerHeight)};return window.addEventListener("resize",L),()=>{window.removeEventListener("resize",L),cancelAnimationFrame(O),c&&d.domElement&&c.contains(d.domElement)&&c.removeChild(d.domElement),v.dispose(),y.dispose(),S.dispose(),R.dispose(),N.dispose(),d.dispose()}},[]),be.useEffect(()=>{if(!n.current||!a.current||!s.current||!l.current)return;const c=Mn.timeline({defaults:{ease:"power3.inOut",duration:1.5}});switch(o){case"home":c.to(n.current.position,{x:0,z:6}),c.to(a.current.material,{opacity:1},0),c.to(l.current.color,{r:.145,g:.388,b:.921},0),c.to(s.current.scale,{x:1,y:1,z:1},0);break;case"work":c.to(n.current.position,{x:3.5,z:3.5}),c.to(a.current.material,{opacity:1},0),c.to(l.current.color,{r:.145,g:.388,b:.921},0),c.to(s.current.scale,{x:1.2,y:1.2,z:1.2},0);break;case"about":c.to(n.current.position,{x:-4,z:4.5}),c.to(a.current.material,{opacity:.1},0),c.to(s.current.scale,{x:2.5,y:2.5,z:2.5,duration:2.5,ease:"slow(0.7, 0.7, false)"},0),c.to(l.current.color,{r:1,g:.717,b:0},0);break;case"contact":c.to(n.current.position,{x:0,y:0,z:14}),c.to(a.current.material,{opacity:0},0),c.to(l.current.color,{r:.13,g:.82,b:.93},0),c.to(s.current.scale,{x:1,y:1,z:1},0);break}},[o]),st.jsx("div",{ref:t,className:"absolute top-0 left-0 w-full h-full z-0 opacity-100 pointer-events-none"})},YC=({onExplore:o,isExploring:t=!1,activeSection:n})=>{const a=be.useRef(null),s=be.useRef(null),l=be.useRef(null),c=be.useRef(null),f=be.useRef(null);return be.useEffect(()=>{const p=Mn.context(()=>{const d="power3.out";if(t){const g="power2.inOut";f.current&&Mn.to(f.current,{y:-30,opacity:0,duration:.8,ease:g}),a.current&&Mn.to(a.current.children,{y:-50,opacity:0,stagger:.05,duration:.8,ease:g}),s.current&&Mn.to(s.current,{y:-50,opacity:0,duration:.8,ease:g,delay:.1}),l.current&&Mn.to(l.current,{y:-20,opacity:0,duration:.8,ease:g,delay:.1}),c.current&&Mn.to(c.current,{opacity:0,scale:.9,duration:.5})}else{const _=Mn.timeline({defaults:{ease:d}});a.current&&s.current&&l.current&&(f.current&&_.fromTo(f.current,{opacity:0,scale:.8},{opacity:1,scale:1,duration:.6}),_.fromTo(a.current.children,{y:100,opacity:0},{y:0,opacity:1,duration:1,stagger:.1}).fromTo(s.current,{y:20,opacity:0},{y:0,opacity:1,duration:.8},"-=0.5").fromTo(l.current,{y:20,opacity:0},{y:0,opacity:1,duration:.8},"-=0.6")),c.current&&Mn.fromTo(c.current.children,{opacity:0,scale:.8},{opacity:1,scale:1,duration:.8,delay:1.5,stagger:.2,ease:"back.out(1.7)"})}});return()=>p.revert()},[t]),st.jsxs("section",{className:"relative w-full h-screen flex flex-col justify-center items-center px-4 overflow-hidden",children:[st.jsx(JS,{activeSection:n}),st.jsxs("div",{ref:c,className:"absolute inset-0 pointer-events-none z-20 overflow-hidden hidden md:block",children:[st.jsx("div",{className:"absolute top-[30%] right-[15%] lg:right-[20%] animate-float-slow",children:st.jsxs("div",{className:"bg-white/70 backdrop-blur-md border border-gray-200/50 shadow-sm rounded-lg px-3 py-1.5 flex items-center gap-2",children:[st.jsx("div",{className:"w-2 h-2 rounded-full bg-green-500 animate-pulse"}),st.jsx("span",{className:"text-xs font-mono text-gray-600 font-medium",children:"Accuracy: 98.2%"})]})}),st.jsx("div",{className:"absolute bottom-[25%] left-[20%] lg:left-[25%] animate-float-delayed",children:st.jsxs("div",{className:"bg-white/70 backdrop-blur-md border border-gray-200/50 shadow-sm rounded-lg px-3 py-1.5 flex items-center gap-2",children:[st.jsx("span",{className:"text-xs font-mono text-gray-500",children:"Epochs:"}),st.jsx("span",{className:"text-xs font-mono text-dark-grey font-bold",children:"500"})]})}),st.jsx("div",{className:"absolute bottom-[35%] right-[10%] lg:right-[15%] animate-float-slower",children:st.jsxs("div",{className:"bg-white/70 backdrop-blur-md border border-gray-200/50 shadow-sm rounded-lg px-3 py-1.5 flex items-col gap-1",children:[st.jsx("span",{className:"text-[10px] uppercase tracking-wider text-gray-400",children:"Loss Function"}),st.jsx("span",{className:"text-xs font-mono text-blue-600 font-medium",children:"0.0241"})]})})]}),st.jsxs("div",{className:"relative z-10 text-center max-w-6xl mx-auto flex flex-col items-center",children:[st.jsxs("div",{className:"relative z-0",children:[st.jsxs("div",{ref:f,className:"mb-6 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-blue-600 text-xs font-semibold tracking-wide uppercase",children:[st.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-blue-600 animate-pulse"}),"AI / ML Specialist"]}),st.jsxs("h1",{ref:a,className:"flex flex-col items-center leading-[0.85] text-dark-grey font-bold tracking-tighter mb-8 select-none",children:[st.jsx("span",{className:"block text-5xl sm:text-7xl md:text-8xl lg:text-[10rem]",children:"From Code"}),st.jsx("span",{className:"block text-5xl sm:text-7xl md:text-8xl lg:text-[10rem] text-transparent bg-clip-text bg-gradient-to-br from-gray-900 via-gray-700 to-gray-500 pb-2",children:"To Reality"})]}),st.jsx("p",{ref:s,className:"text-lg md:text-xl text-gray-500 max-w-2xl mx-auto text-center mb-10 leading-relaxed font-normal",children:"Building the next generation of cognitive systems. Focusing on Large Language Models, Computer Vision, and Predictive Analytics."})]}),st.jsxs("div",{ref:l,className:"relative z-30 flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto",children:[st.jsxs(Hp,{variant:"primary",className:"w-full sm:w-auto shadow-xl shadow-blue-600/10",onClick:o,children:["Explore Projects",st.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[st.jsx("path",{d:"M5 12h14"}),st.jsx("path",{d:"m12 5 7 7-7 7"})]})]}),st.jsx(Hp,{variant:"secondary",className:"w-full sm:w-auto bg-white/50 backdrop-blur-sm",onClick:()=>window.open("https://github.com/shrudaysimha","_blank"),children:"GitHub Profile"})]})]}),st.jsx("style",{children:`
      ...
      `})]})},jC=()=>st.jsx("div",{className:"fixed inset-0 pointer-events-none z-50 opacity-[0.03] mix-blend-multiply",style:{backgroundImage:`url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.65' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E")`,backgroundRepeat:"repeat"}}),ZC=({onBack:o})=>{const t=be.useRef(null),n=be.useRef(null);return be.useEffect(()=>{t.current&&Mn.fromTo(t.current.children,{opacity:0,x:50},{opacity:1,x:0,duration:.8,stagger:.2,delay:.5,ease:"power3.out"}),n.current&&Mn.fromTo(n.current,{opacity:0,y:-20},{opacity:1,y:0,duration:.6,delay:.8,ease:"power2.out"})},[]),st.jsxs("section",{className:"absolute top-0 right-0 w-full md:w-[60%] h-screen overflow-y-auto z-40 bg-black/80 md:bg-transparent backdrop-blur-md md:backdrop-blur-none scroll-smooth",children:[st.jsx("div",{className:"fixed top-6 right-6 z-50",children:st.jsxs("button",{ref:n,onClick:o,className:"group flex items-center gap-2 text-gray-400 hover:text-white transition-colors duration-300 text-sm font-medium uppercase tracking-wide px-4 py-2 rounded-full border border-white/10 bg-black/20 backdrop-blur-md hover:bg-white/10",children:[st.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"group-hover:-translate-x-1 transition-transform",children:st.jsx("path",{d:"m15 18-6-6 6-6"})}),"Back"]})}),st.jsx("div",{className:"flex flex-col",children:st.jsxs("div",{ref:t,className:"min-h-screen p-8 md:p-12 lg:p-16 flex flex-col justify-center space-y-8",children:[st.jsxs("div",{className:"mb-2 pt-16 md:pt-0",children:[st.jsx("h2",{className:"text-3xl md:text-5xl font-bold tracking-tight text-white mb-4",children:"Selected Work"}),st.jsx("p",{className:"text-gray-400 max-w-md",children:"Deep dives into machine learning architectures, robotics, and data-driven intelligence."})]}),st.jsxs("div",{onClick:()=>window.open("https://github.com/shrudaysimha/RENEWABLE-ENERGY-POWERED-VEHICLE","_blank"),className:"group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors duration-300 cursor-pointer",children:[st.jsxs("div",{className:"flex justify-between items-start mb-4",children:[st.jsx("div",{className:"px-3 py-1 bg-orange-500/20 text-orange-300 rounded-full text-xs font-mono border border-orange-500/30",children:"Robotics / IoT"}),st.jsxs("div",{className:"flex items-center gap-2",children:[st.jsx("span",{className:"text-gray-500 text-xs font-mono",children:"2025"}),st.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"text-gray-500 group-hover:text-orange-400 transition-colors",children:[st.jsx("path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"}),st.jsx("polyline",{points:"15 3 21 3 21 9"}),st.jsx("line",{x1:"10",y1:"14",x2:"21",y2:"3"})]})]})]}),st.jsx("h3",{className:"text-2xl text-gray-100 font-semibold mb-2 group-hover:text-orange-400 transition-colors",children:"Eco-Nav Autonomous Vehicle"}),st.jsx("p",{className:"text-gray-400 text-sm leading-relaxed mb-4",children:"A renewable energy-powered autonomous vehicle featuring real-time obstacle avoidance. Integrated solar charging with ultrasonic sensor arrays for continuous, safe navigation."}),st.jsxs("div",{className:"flex items-center gap-2 mt-2",children:[st.jsx("div",{className:"w-full h-1 bg-gray-800 rounded-full overflow-hidden flex-1",children:st.jsx("div",{className:"w-1/2 h-full bg-orange-500/50"})}),st.jsx("span",{className:"text-[10px] text-orange-400 font-mono",children:"SOLAR"})]})]})]})})]})},KC=({onBack:o})=>{const t=be.useRef(null),n=be.useRef(null);return be.useEffect(()=>{t.current&&Mn.fromTo(t.current,{opacity:0,scale:.95},{opacity:1,scale:1,duration:.8,ease:"power3.out"}),n.current&&Mn.fromTo(n.current,{opacity:0,y:-20},{opacity:1,y:0,duration:.6,delay:.5,ease:"power2.out"})},[]),st.jsxs("section",{className:"absolute top-0 right-0 w-full h-screen overflow-hidden z-40 bg-black/80 md:bg-transparent backdrop-blur-md md:backdrop-blur-none flex items-center justify-center",children:[st.jsx("div",{className:"fixed top-6 right-6 z-50",children:st.jsxs("button",{ref:n,onClick:o,className:"group flex items-center gap-2 text-gray-400 hover:text-white transition-colors duration-300 text-sm font-medium uppercase tracking-wide px-4 py-2 rounded-full border border-white/10 bg-black/20 backdrop-blur-md hover:bg-white/10",children:[st.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"group-hover:-translate-x-1 transition-transform",children:st.jsx("path",{d:"m15 18-6-6 6-6"})}),"Back"]})}),st.jsx("div",{ref:t,className:"w-full max-w-5xl p-4 md:p-8",children:st.jsxs("div",{className:"w-full relative bg-white/5 backdrop-blur-xl border-l border-white/20 rounded-xl md:rounded-3xl p-6 md:p-0 overflow-hidden flex flex-col md:flex-row shadow-2xl shadow-black/50",children:[st.jsx("div",{className:"hidden md:flex w-16 bg-black/20 border-r border-white/10 items-center justify-center",children:st.jsx("span",{className:"transform -rotate-90 whitespace-nowrap text-xs font-bold tracking-[0.3em] text-white/40 uppercase",children:"About The Architect"})}),st.jsx("div",{className:"flex-1 p-6 md:p-10 flex flex-col justify-center",children:st.jsxs("div",{className:"space-y-6",children:[st.jsxs("h3",{className:"text-3xl font-bold text-white",children:["Building the ",st.jsx("span",{className:"text-blue-500",children:"Future"})," of Intelligence."]}),st.jsx("div",{className:"space-y-4 text-sm md:text-base text-gray-300 font-light",children:st.jsxs("div",{className:"grid grid-cols-1 gap-4",children:[st.jsxs("div",{className:"bg-white/5 p-4 rounded-lg border border-white/5 hover:border-blue-500/30 transition-colors",children:[st.jsx("span",{className:"block text-xs font-bold text-blue-400 uppercase tracking-wider mb-1",children:"Where I’m working"}),st.jsx("p",{children:"Currently a first-year AI & Data Science student at CMRIT building strong foundations in coding, math, and AI projects."})]}),st.jsxs("div",{className:"bg-white/5 p-4 rounded-lg border border-white/5 hover:border-purple-500/30 transition-colors",children:[st.jsx("span",{className:"block text-xs font-bold text-purple-400 uppercase tracking-wider mb-1",children:"What I’m currently learning"}),st.jsx("p",{children:"C/C++, Python, Data Structures, Machine Learning, and engineering fundamentals."})]}),st.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:[st.jsxs("div",{className:"bg-white/5 p-4 rounded-lg border border-white/5 hover:border-green-500/30 transition-colors",children:[st.jsx("span",{className:"block text-xs font-bold text-green-400 uppercase tracking-wider mb-1",children:"Collaborate on"}),st.jsx("p",{children:"Beginner–intermediate AI, ML, data science, and automation projects."})]}),st.jsxs("div",{className:"bg-white/5 p-4 rounded-lg border border-white/5 hover:border-yellow-500/30 transition-colors",children:[st.jsx("span",{className:"block text-xs font-bold text-yellow-400 uppercase tracking-wider mb-1",children:"Looking for help with"}),st.jsx("p",{children:"Improving real-world project structure, best coding practices, and research-oriented workflows."})]})]}),st.jsxs("div",{className:"bg-white/5 p-4 rounded-lg border border-white/5 hover:border-pink-500/30 transition-colors",children:[st.jsx("span",{className:"block text-xs font-bold text-pink-400 uppercase tracking-wider mb-1",children:"Ask me about"}),st.jsx("p",{children:"AI agents, problem-solving approaches, early-stage research ideas, and academic guidance."})]}),st.jsxs("div",{className:"italic text-gray-400 border-l-2 border-white/20 pl-4 py-1",children:[st.jsx("span",{className:"font-semibold text-white",children:"Fun fact:"})," I love turning simple ideas into practical prototypes—even if it means building them from scratch!"]})]})})]})})]})})]})},QC=({onBack:o})=>{const t=be.useRef(null),n=be.useRef(null),a=be.useRef(null),[s,l]=be.useState(!1);be.useEffect(()=>{const d=Mn.timeline({defaults:{ease:"power3.out"}});t.current&&d.fromTo(t.current,{opacity:0},{opacity:.15,duration:1.5}),n.current&&d.fromTo(n.current.children,{y:50,opacity:0},{y:0,opacity:1,stagger:.15,duration:1},"-=1.0"),a.current&&d.fromTo(a.current,{opacity:0,y:-20},{opacity:1,y:0,duration:.6},"-=0.6")},[]);const c=()=>{try{const d=window.AudioContext||window.webkitAudioContext;if(!d)return;const _=new d,g=_.createOscillator(),v=_.createGain();g.connect(v),v.connect(_.destination),g.type="sine",g.frequency.setValueAtTime(800,_.currentTime),g.frequency.exponentialRampToValueAtTime(1200,_.currentTime+.1),v.gain.setValueAtTime(.05,_.currentTime),v.gain.exponentialRampToValueAtTime(.001,_.currentTime+.1),g.start(),g.stop(_.currentTime+.1)}catch{}},f=d=>{d.preventDefault(),!s&&(navigator.clipboard.writeText("shrudaysimha@gmail.com"),l(!0),c(),setTimeout(()=>{l(!1)},2e3))},p=[{label:"LINKEDIN",sub:"NETWORK",href:"https://linkedin.com",icon:st.jsxs("svg",{className:"w-8 h-8 text-white",fill:"none",viewBox:"0 0 24 24",children:[st.jsx("path",{stroke:"currentColor",strokeWidth:"1.5",d:"M4 4h4v4H4zM4 16h4v4H4zM16 4h4v4h-4zM16 16h4v4h-4z"}),st.jsx("path",{stroke:"currentColor",strokeWidth:"1.5",d:"M8 6h8M6 8v8M18 8v8M8 18h8",strokeOpacity:"0.5"})]})},{label:"GITHUB",sub:"REPOSITORIES",href:"https://github.com/shrudaysimha",icon:st.jsxs("svg",{className:"w-8 h-8 text-white",fill:"none",viewBox:"0 0 24 24",children:[st.jsx("path",{stroke:"currentColor",strokeWidth:"1.5",d:"M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z",clipPath:"inset(50% 0 0 0)"}),st.jsx("rect",{x:"4",y:"14",width:"6",height:"6",stroke:"currentColor",strokeWidth:"1.5"}),st.jsx("rect",{x:"14",y:"14",width:"6",height:"6",stroke:"currentColor",strokeWidth:"1.5"}),st.jsx("path",{d:"M12 4v8M7 14l5-4 5 4",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"square"})]})},{label:"EMAIL",sub:"CONTACT",href:"mailto:shrudaysimha@gmail.com",isEmail:!0,icon:st.jsxs("svg",{className:"w-8 h-8 text-white",fill:"none",viewBox:"0 0 24 24",children:[st.jsx("path",{stroke:"currentColor",strokeWidth:"1.5",d:"M2 6h20v12H2z"}),st.jsx("path",{stroke:"currentColor",strokeWidth:"1.5",d:"M2 6l10 7 10-7"}),st.jsx("circle",{cx:"12",cy:"13",r:"2",stroke:"currentColor",strokeWidth:"1.5",fill:"none"})]})}];return st.jsxs("div",{className:"fixed inset-0 z-50 flex flex-col items-center justify-center overflow-hidden",children:[st.jsx("div",{ref:t,className:"absolute inset-0 pointer-events-none",style:{backgroundImage:`linear-gradient(rgba(6, 182, 212, 0.3) 1px, transparent 1px),
                                      linear-gradient(90deg, rgba(6, 182, 212, 0.3) 1px, transparent 1px)`,backgroundSize:"40px 40px",maskImage:"radial-gradient(circle at center, black 40%, transparent 80%)"}}),st.jsx("div",{className:"fixed top-6 right-6 z-50",children:st.jsxs("button",{ref:a,onClick:o,className:"group flex items-center gap-2 text-cyan-400 hover:text-cyan-200 transition-colors duration-300 text-sm font-mono uppercase tracking-widest px-4 py-2 rounded-full border border-cyan-500/20 bg-black/40 backdrop-blur-md hover:bg-cyan-900/20",children:[st.jsx("span",{className:"text-xs mr-1",children:"[ESC]"}),"Abort"]})}),st.jsxs("div",{ref:n,className:"flex flex-col gap-4 w-full px-4 md:items-center",children:[st.jsxs("div",{className:"text-center mb-8",children:[st.jsx("h2",{className:"text-sm font-mono text-cyan-500 tracking-[0.3em] uppercase mb-2",children:"System // Connect"}),st.jsx("div",{className:"w-1 h-8 bg-gradient-to-b from-cyan-500 to-transparent mx-auto"})]}),p.map((d,_)=>{const g=d.isEmail&&s;return st.jsxs("a",{href:d.isEmail?"#":d.href,onClick:d.isEmail?f:void 0,target:d.isEmail?void 0:"_blank",rel:d.isEmail?void 0:"noopener noreferrer",className:`group relative w-full md:w-[600px] h-24 flex items-center bg-white/5 backdrop-blur-lg border border-white/10 hover:border-[#00f3ff] transition-all duration-500 ease-out hover:translate-x-5 overflow-hidden rounded-sm ${g?"border-green-500/50":""}`,children:[st.jsx("div",{className:"absolute inset-0 bg-[#00f3ff]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"}),st.jsx("div",{className:"absolute left-0 w-12 h-full flex items-center justify-center -translate-x-full group-hover:translate-x-0 transition-transform duration-300 ease-out",children:st.jsx("svg",{className:`w-6 h-6 ${g?"text-green-400":"text-[#00f3ff]"}`,fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:st.jsx("path",{strokeLinecap:"square",strokeLinejoin:"miter",strokeWidth:"2",d:"M9 5l7 7-7 7"})})}),st.jsxs("div",{className:"flex-1 flex items-center justify-between px-8 pl-8 group-hover:pl-16 transition-all duration-300",children:[st.jsxs("div",{className:"flex flex-col",children:[st.jsx("span",{className:`text-2xl md:text-3xl font-mono font-light transition-colors duration-300 tracking-tight ${g?"text-green-400 font-bold":"text-white group-hover:text-[#00f3ff]"}`,children:g?"COPIED TO CLIPBOARD":d.label}),st.jsxs("span",{className:`text-[10px] font-mono tracking-[0.2em] uppercase ${g?"text-green-400/60":"text-gray-500 group-hover:text-[#00f3ff]/60"}`,children:["// ",g?"shrudaysimha@gmail.com":d.sub]})]}),st.jsx("div",{className:`w-12 h-12 flex items-center justify-center opacity-60 group-hover:opacity-100 group-hover:scale-110 transition-all duration-500 ${g?"text-green-400 opacity-100":""}`,children:d.icon})]}),st.jsx("div",{className:`absolute top-0 left-0 w-2 h-2 border-t border-l border-white/30 group-hover:border-[#00f3ff] ${g?"border-green-400":""}`}),st.jsx("div",{className:`absolute bottom-0 right-0 w-2 h-2 border-b border-r border-white/30 group-hover:border-[#00f3ff] ${g?"border-green-400":""}`})]},_)})]})]})},JC=({isDark:o})=>{const t=be.useRef(null);return be.useEffect(()=>{const n=s=>{Mn.to(t.current,{x:s.clientX,y:s.clientY,duration:.2,ease:"power2.out"})},a=s=>{const l=s.target;l.tagName.toLowerCase()==="button"||l.tagName.toLowerCase()==="a"||l.closest("button")||l.closest("a")||l.classList.contains("interactive")?Mn.to(t.current,{scale:3,opacity:.4,duration:.2}):Mn.to(t.current,{scale:1,opacity:.8,duration:.2})};return window.addEventListener("mousemove",n),window.addEventListener("mouseover",a),()=>{window.removeEventListener("mousemove",n),window.removeEventListener("mouseover",a)}},[]),st.jsx("div",{ref:t,className:`
        fixed top-0 left-0 w-6 h-6 rounded-full pointer-events-none z-[9999] 
        transform -translate-x-1/2 -translate-y-1/2
        transition-colors duration-500 ease-in-out
        ${o?"bg-[#f4f4f0]":"bg-gray-800"}
      `})},$C=()=>{const[o,t]=be.useState("home"),n=be.useRef(null),a=o==="projects"?"work":o==="about"?"about":o==="contact"?"contact":"home",s=o!=="home";return be.useEffect(()=>{if(n.current){let l="#f4f4f0";o==="contact"?l="#0b0f19":o!=="home"&&(l="#0f0f0f"),Mn.to(n.current,{backgroundColor:l,duration:1.5,ease:"power2.inOut",delay:o!=="home"?.2:0})}},[o]),st.jsxs("main",{ref:n,className:"relative min-h-screen w-full bg-paper text-dark-grey font-sans selection:bg-blue-200 selection:text-blue-900 overflow-x-hidden transition-colors",children:[st.jsx(jC,{}),st.jsx(JC,{isDark:s}),st.jsx(JS,{activeSection:a}),st.jsxs("div",{className:"relative z-20",children:[st.jsx(LE,{isHidden:o!=="home",onNavigate:t}),st.jsx("div",{className:o!=="home"?"pointer-events-none":"",children:st.jsx(YC,{isExploring:o!=="home",onExplore:()=>t("projects"),activeSection:o==="projects"?"work":o})}),o==="projects"&&st.jsx(ZC,{onBack:()=>t("home")}),o==="about"&&st.jsx(KC,{onBack:()=>t("home")}),o==="contact"&&st.jsx(QC,{onBack:()=>t("home")})]})]})};pb.createRoot(document.getElementById("root")).render(st.jsx(sb.StrictMode,{children:st.jsx($C,{})}));
