...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qa,depthTest:!1,depthWrite:!1})}function kR(o,t,n){const a=new Float32Array(bs),s=new it(0,1,0);return new sa({name:"SphericalGaussianBlur",defines:{n:bs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${o}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:a},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Df(),fragmentShader:`
	...
	`}function XR(o){let t=new WeakMap,n=null;function a(f){if(f&&f.isTexture){const p=f.mapping,d=p===Kp||p===Qp,_=p===Us||p===Wo;if(d||_){let g=t.get(f);const v=g!==void 0?g.texture.pmremVersion:0;if(f.isRenderTargetTexture&&f.pmremVersion!==v)return n===null&&(n=new Zx(o)),g=d?n.fromEquirectangular(f,g):n.fromCubemap(f,g),g.texture.pmremVersion=f.pmremVersion,t.set(f,g),g.texture;if(g!==void 0)return g.texture;{const y=f.image;return d&&y&&y.height>0||_&&y&&s(y)?(n===null&&(n=new Zx(o)),g=d?n.fromEquirectangular(f):n.fromCubemap(f),g.texture.pmremVersion=f.pmremVersion,t.set(f,g),f.addEventListener("dispose",l),g.texture):null}}}return f}function s(f){let p=0;const d=6;for(let _=0;_<d;_++)f[_]!==void 0&&p++;return p===d}function l(f){const p=f.target;p.removeEventListener("dispose",l);const d=t.get(p);d!==void 0&&(t.delete(p),d.dispose())}function c(){t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:a,dispose:c}}function WR(o){const t={};function n(a){if(t[a]!==void 0)return t[a];const s=o.getExtension(a);return t[a]=s,s}return{has:function(a){return n(a)!==null},init:function(){n("EXT_color_buffer_float"),n("WEBGL_clip_cull_distance"),n("OES_texture_float_linear"),n("EXT_color_buffer_half_float"),n("WEBGL_multisampled_render_to_texture"),n("WEBGL_render_shared_exponent")},get:function(a){const s=n(a);return s===null&&mu("WebGLRenderer: "+a+" extension not supported."),s}}}function qR(o,t,n,a){const s={},l=new WeakMap;function c(g){const v=g.target;v.index!==null&&t.remove(v.index);for(const E in v.attributes)t.remove(v.attributes[E]);v.removeEventListener("dispose",c),delete s[v.id];const y=l.get(v);y&&(t.remove(y),l.delete(v)),a.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,n.memory.geometries--}function f(g,v){return s[v.id]===!0||(v.addEventListener("dispose",c),s[v.id]=!0,n.memory.geometries++),v}function p(g){const v=g.attributes;for(const y in v)t.update(v[y],o.ARRAY_BUFFER)}function d(g){const v=[],y=g.index,E=g.attributes.position;let M=0;if(y!==null){const R=y.array;M=y.version;for(let w=0,C=R.length;w<C;w+=3){const N=R[w+0],P=R[w+1],O=R[w+2];v.push(N,P,P,O,O,N)}}else if(E!==void 0){const R=E.array;M=E.version;for(let w=0,C=R.length/3-1;w<C;w+=3){const N=w+0,P=w+1,O=w+2;v.push(N,P,P,O,O,N)}}else return;const S=new(US(v)?BS:FS)(v,1);S.version=M;const x=l.get(g);x&&t.remove(x),l.set(g,S)}function _(g){const v=l.get(g);if(v){const y=g.index;y!==null&&v.version<y.version&&d(g)}else d(g);return l.get(g)}return{get:f,update:p,getWireframeAttribute:_}}function YR(o,t,n){let a;function s(v){a=v}let l,c;function f(v){l=v.type,c=v.bytesPerElement}function p(v,y){o.drawElements(a,y,l,v*c),n.update(y,a,1)}function d(v,y,E){E!==0&&(o.drawElementsInstanced(a,y,l,v*c,E),n.update(y,a,E))}function _(v,y,E){if(E===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(a,y,0,l,v,0,E);let S=0;for(let x=0;x<E;x++)S+=y[x];n.update(S,a,1)}function g(v,y,E,M){if(E===0)return;const S=t.get("WEBGL_multi_draw");if(S===null)for(let x=0;x<v.length;x++)d(v[x]/c,y[x],M[x]);else{S.multiDrawElementsInstancedWEBGL(a,y,0,l,v,0,M,0,E);let x=0;for(let R=0;R<E;R++)x+=y[R]*M[R];n.update(x,a,1)}}this.setMode=s,this.setIndex=f,this.render=p,this.renderInstances=d,this.renderMultiDraw=_,this.renderMultiDrawInstances=g}function jR(o){const t={geometries:0,textures:0},n={frame:0,calls:0,triangles:0,points:0,lines:0};function a(l,c,f){switch(n.calls++,c){case o.TRIANGLES:n.triangles+=f*(l/3);break;case o.LINES:n.lines+=f*(l/2);break;case o.LINE_STRIP:n.lines+=f*(l-1);break;case o.LINE_LOOP:n.lines+=f*l;break;case o.POINTS:n.points+=f*l;break;default:Ce("WebGLInfo: Unknown draw mode:",c);break}}function s(){n.calls=0,n.triangles=0,n.points=0,n.lines=0}return{memory:t,render:n,programs:null,autoReset:!0,reset:s,update:a}}function ZR(o,t,n){const a=new WeakMap,s=new dn;function l(c,f,p){const d=c.morphTargetInfluences,_=f.morphAttributes.position||f.morphAttributes.normal||f.morphAttributes.color,g=_!==void 0?_.length:0;let v=a.get(f);if(v===void 0||v.count!==g){let L=function(){I.dispose(),a.delete(f),f.removeEventListener("dispose",L)};var y=L;v!==void 0&&v.texture.dispose();const E=f.morphAttributes.position!==void 0,M=f.morphAttributes.normal!==void 0,S=f.morphAttributes.color!==void 0,x=f.morphAttributes.position||[],R=f.morphAttributes.normal||[],w=f.morphAttributes.color||[];let C=0;E===!0&&(C=1),M===!0&&(C=2),S===!0&&(C=3);let N=f.attributes.position.count*C,P=1;N>t.maxTextureSize&&(P=Math.ceil(N/t.maxTextureSize),N=t.maxTextureSize);const O=new Float32Array(N*P*4*g),I=new NS(O,N,P,g);I.type=va,I.needsUpdate=!0;const T=C*4;for(let H=0;H<g;H++){const Y=x[H],K=R[H],ut=w[H],ot=N*P*4*H;for(let B=0;B<Y.count;B++){const G=B*T;E===!0&&(s.fromBufferAttribute(Y,B),O[ot+G+0]=s.x,O[ot+G+1]=s.y,O[ot+G+2]=s.z,O[ot+G+3]=0),M===!0&&(s.fromBufferAttribute(K,B),O[ot+G+4]=s.x,O[ot+G+5]=s.y,O[ot+G+6]=s.z,O[ot+G+7]=0),S===!0&&(s.fromBufferAttribute(ut,B),O[ot+G+8]=s.x,O[ot+G+9]=s.y,O[ot+G+10]=s.z,O[ot+G+11]=ut.itemSize===4?s.w:1)}}v={count:g,texture:I,size:new Le(N,P)},a.set(f,v),f.addEventListener("dispose",L)}if(c.isInstancedMesh===!0&&c.morphTexture!==null)p.getUniforms().setValue(o,"morphTexture",c.morphTexture,n);else{let E=0;for(let S=0;S<d.length;S++)E+=d[S];const M=f.morphTargetsRelative?1:1-E;p.getUniforms().setValue(o,"morphTargetBaseInfluence",M),p.getUniforms().setValue(o,"morphTargetInfluences",d)}p.getUniforms().setValue(o,"morphTargetsTexture",v.texture,n),p.getUniforms().setValue(o,"morphTargetsTextureSize",v.size)}return{update:l}}function KR(o,t,n,a){let s=new WeakMap;function l(p){const d=a.render.frame,_=p.geometry,g=t.get(p,_);if(s.get(g)!==d&&(t.update(g),s.set(g,d)),p.isInstancedMesh&&(p.hasEventListener("dispose",f)===!1&&p.addEventListener("dispose",f),s.get(p)!==d&&(n.update(p.instanceMatrix,o.ARRAY_BUFFER),p.instanceColor!==null&&n.update(p.instanceColor,o.ARRAY_BUFFER),s.set(p,d))),p.isSkinnedMesh){const v=p.skeleton;s.get(v)!==d&&(v.update(),s.set(v,d))}return g}function c(){s=new WeakMap}function f(p){const d=p.target;d.removeEventListener("dispose",f),n.remove(d.instanceMatrix),d.instanceColor!==null&&n.remove(d.instanceColor)}return{update:l,dispose:c}}const QR={[_S]:"LINEAR_TONE_MAPPING",[gS]:"REINHARD_TONE_MAPPING",[vS]:"CINEON_TONE_MAPPING",[xS]:"ACES_FILMIC_TONE_MAPPING",[SS]:"AGX_TONE_MAPPING",[MS]:"NEUTRAL_TONE_MAPPING",[yS]:"CUSTOM_TONE_MAPPING"};function JR(o,t,n,a,s){const l=new Sa(t,n,{type:o,depthBuffer:a,stencilBuffer:s}),c=new Sa(t,n,{type:er,depthBuffer:!1,stencilBuffer:!1}),f=new Yi;f.setAttribute("position",new Ri([-1,3,0,-1,-1,0,3,-1,0],3)),f.setAttribute("uv",new Ri([0,2,0,0,2,0],2));const p=new qT({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
void main() {
    ...
    `,v=new h0(2.2,1),y=v.toNonIndexed(),E=y.attributes.position.count,M=[];for(let H=0;H<E;H+=3)M.push(1,0,0,0,1,0,0,0,1);y.setAttribute("barycentric",new Ri(M,3));const S=new sa({vertexShader:_,fragmentShader:g,uniforms:{uTime:{value:0}},side:_a,transparent:!0}),x=new Ea(y,S);x.position.set(1.8,0,0),a.current=x,f.add(x);const R=new Yi,w=800,C=new Float32Array(w*3);for(let H=0;H<w;H++){const Y=4+Math.random()*2,K=Math.random()*Math.PI*2,ut=Math.acos(2*Math.random()-1);C[H*3]=Y*Math.sin(ut)*Math.cos(K),C[H*3+1]=Y*Math.sin(ut)*Math.sin(K),C[H*3+2]=Y*Math.cos(ut)}R.setAttribute("position",new ra(C,3));const N=new XS({size:.04,color:new ze(2450411),transparent:!0,opacity:.6,sizeAttenuation:!0});l.current=N;const P=new XT(R,N);s.current=P,f.add(P);let O;const I=new KT,T=()=>{O=requestAnimationFrame(T);const H=I.getElapsedTime();S.uniforms.uTime.value=H,a.current&&(a.current.rotation.x=Math.sin(H*.1)*.2,a.current.rotation.y=H*.15,a.current.position.y=Math.sin(H*.5)*.1),s.current&&(s.current.rotation.y=-H*.05,s.current.rotation.x=Math.sin(H*.05)*.1),d.render(f,p)};T();const L=()=>{p.aspect=window.innerWidth/window.innerHeight,p.updateProjectionMatrix(),d.setSize(window.innerWidth,window.innerHeight)};return window.addEventListener("resize",L),()=>{window.removeEventListener("resize",L),cancelAnimationFrame(O),c&&d.domElement&&c.contains(d.domElement)&&c.removeChild(d.domElement),v.dispose(),y.dispose(),S.dispose(),R.dispose(),N.dispose(),d.dispose()}},[]),Te.useEffect(()=>{if(!n.current||!a.current||!s.current||!l.current)return;const c=Mn.timeline({defaults:{ease:"power3.inOut",duration:1.5}});switch(o){case"home":c.to(n.current.position,{x:0,z:6}),c.to(a.current.position,{x:1.8,y:0,z:0},0),c.to(a.current.material,{opacity:1},0),c.to(l.current.color,{r:.145,g:.388,b:.921},0),c.to(s.current.scale,{x:1,y:1,z:1},0);break;case"work":c.to(n.current.position,{x:3.5,z:3.5}),c.to(a.current.position,{x:1.8,y:0,z:0},0),c.to(a.current.material,{opacity:1},0),c.to(l.current.color,{r:.145,g:.388,b:.921},0),c.to(s.current.scale,{x:1.2,y:1.2,z:1.2},0);break;case"about":c.to(n.current.position,{x:0,z:6}),c.to(a.current.position,{x:3.5,y:0,z:0},0),c.to(a.current.material,{opacity:1},0),c.to(s.current.scale,{x:2.5,y:2.5,z:2.5,duration:2.5,ease:"slow(0.7, 0.7, false)"},0),c.to(l.current.color,{r:1,g:.717,b:0},0);break;case"contact":c.to(n.current.position,{x:0,y:0,z:14}),c.to(a.current.material,{opacity:0},0),c.to(l.current.color,{r:.13,g:.82,b:.93},0),c.to(s.current.scale,{x:1,y:1,z:1},0);break}},[o]),$.jsx("div",{ref:t,className:"fixed top-0 left-0 w-full h-full z-0 pointer-events-none"})},YC=({onExplore:o,isExploring:t=!1,activeSection:n})=>{const a=Te.useRef(null),s=Te.useRef(null),l=Te.useRef(null),c=Te.useRef(null),f=Te.useRef(null);return Te.useEffect(()=>{const p=Mn.context(()=>{const d="power3.out";if(t){const g="power2.inOut";f.current&&Mn.to(f.current,{y:-30,opacity:0,duration:.8,ease:g}),a.current&&Mn.to(a.current.children,{y:-50,opacity:0,stagger:.05,duration:.8,ease:g}),s.current&&Mn.to(s.current,{y:-50,opacity:0,duration:.8,ease:g,delay:.1}),l.current&&Mn.to(l.current,{y:-20,opacity:0,duration:.8,ease:g,delay:.1}),c.current&&Mn.to(c.current,{opacity:0,scale:.9,duration:.5})}else{const _=Mn.timeline({defaults:{ease:d}});a.current&&s.current&&l.current&&(f.current&&_.fromTo(f.current,{opacity:0,scale:.8},{opacity:1,scale:1,duration:.6}),_.fromTo(a.current.children,{y:100,opacity:0},{y:0,opacity:1,duration:1,stagger:.1}).fromTo(s.current,{y:20,opacity:0},{y:0,opacity:1,duration:.8},"-=0.5").fromTo(l.current,{y:20,opacity:0},{y:0,opacity:1,duration:.8},"-=0.6")),c.current&&Mn.fromTo(c.current.children,{opacity:0,scale:.8},{opacity:1,scale:1,duration:.8,delay:1.5,stagger:.2,ease:"back.out(1.7)"})}});return()=>p.revert()},[t]),$.jsxs("section",{className:"relative w-full h-screen flex flex-col justify-center items-center px-4 overflow-hidden",children:[$.jsx(JS,{activeSection:n}),$.jsxs("div",{ref:c,className:"absolute inset-0 pointer-events-none z-20 overflow-hidden hidden md:block",children:[$.jsx("div",{className:"absolute top-[30%] right-[15%] lg:right-[20%] animate-float-slow",children:$.jsxs("div",{className:"bg-white/70 backdrop-blur-md border border-gray-200/50 shadow-sm rounded-lg px-3 py-1.5 flex items-center gap-2",children:[$.jsx("div",{className:"w-2 h-2 rounded-full bg-green-500 animate-pulse"}),$.jsx("span",{className:"text-xs font-mono text-gray-600 font-medium",children:"Accuracy: 98.2%"})]})}),$.jsx("div",{className:"absolute bottom-[25%] left-[20%] lg:left-[25%] animate-float-delayed",children:$.jsxs("div",{className:"bg-white/70 backdrop-blur-md border border-gray-200/50 shadow-sm rounded-lg px-3 py-1.5 flex items-center gap-2",children:[$.jsx("span",{className:"text-xs font-mono text-gray-500",children:"Epochs:"}),$.jsx("span",{className:"text-xs font-mono text-dark-grey font-bold",children:"500"})]})}),$.jsx("div",{className:"absolute bottom-[35%] right-[10%] lg:right-[15%] animate-float-slower",children:$.jsxs("div",{className:"bg-white/70 backdrop-blur-md border border-gray-200/50 shadow-sm rounded-lg px-3 py-1.5 flex items-col gap-1",children:[$.jsx("span",{className:"text-[10px] uppercase tracking-wider text-gray-400",children:"Loss Function"}),$.jsx("span",{className:"text-xs font-mono text-blue-600 font-medium",children:"0.0241"})]})})]}),$.jsxs("div",{className:"relative z-10 text-center max-w-6xl mx-auto flex flex-col items-center",children:[$.jsxs("div",{className:"relative z-0",children:[$.jsxs("div",{ref:f,className:"mb-6 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-blue-600 text-xs font-semibold tracking-wide uppercase",children:[$.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-blue-600 animate-pulse"}),"AI / ML Specialist"]}),$.jsxs("h1",{ref:a,className:"flex flex-col items-center leading-[0.85] text-dark-grey font-bold tracking-tighter mb-8 select-none",children:[$.jsx("span",{className:"block text-5xl sm:text-7xl md:text-8xl lg:text-[10rem]",children:"From Code"}),$.jsx("span",{className:"block text-5xl sm:text-7xl md:text-8xl lg:text-[10rem] text-transparent bg-clip-text bg-gradient-to-br from-gray-900 via-gray-700 to-gray-500 pb-2",children:"To Reality"})]}),$.jsx("p",{ref:s,className:"text-lg md:text-xl text-gray-500 max-w-2xl mx-auto text-center mb-10 leading-relaxed font-normal",children:"Building the next generation of cognitive systems. Focusing on Large Language Models, Computer Vision, and Predictive Analytics."})]}),$.jsxs("div",{ref:l,className:"relative z-30 flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto",children:[$.jsxs(Hp,{variant:"primary",className:"w-full sm:w-auto shadow-xl shadow-blue-600/10",onClick:o,children:["Explore Projects",$.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[$.jsx("path",{d:"M5 12h14"}),$.jsx("path",{d:"m12 5 7 7-7 7"})]})]}),$.jsx(Hp,{variant:"secondary",className:"w-full sm:w-auto bg-white/50 backdrop-blur-sm",onClick:()=>window.open("https://github.com/shrudaysimha","_blank"),children:"GitHub Profile"})]})]}),$.jsx("style",{children:`
      ...
      `})]})},jC=()=>$.jsx("div",{className:"fixed inset-0 pointer-events-none z-50 opacity-[0.03] mix-blend-multiply",style:{backgroundImage:`url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.65' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E")`,backgroundRepeat:"repeat"}}),ZC=({onBack:o})=>{const t=Te.useRef(null),n=Te.useRef(null);return Te.useEffect(()=>{t.current&&Mn.fromTo(t.current.children,{opacity:0,x:50},{opacity:1,x:0,duration:.8,stagger:.2,delay:.5,ease:"power3.out"}),n.current&&Mn.fromTo(n.current,{opacity:0,y:-20},{opacity:1,y:0,duration:.6,delay:.8,ease:"power2.out"})},[]),$.jsxs("section",{className:"absolute top-0 right-0 w-full md:w-[60%] h-screen overflow-y-auto z-40 bg-black/80 md:bg-transparent backdrop-blur-md md:backdrop-blur-none scroll-smooth",children:[$.jsx("div",{className:"fixed top-6 right-6 z-50",children:$.jsxs("button",{ref:n,onClick:o,className:"group flex items-center gap-2 text-gray-400 hover:text-white transition-colors duration-300 text-sm font-medium uppercase tracking-wide px-4 py-2 rounded-full border border-white/10 bg-black/20 backdrop-blur-md hover:bg-white/10",children:[$.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"group-hover:-translate-x-1 transition-transform",children:$.jsx("path",{d:"m15 18-6-6 6-6"})}),"Back"]})}),$.jsx("div",{className:"flex flex-col",children:$.jsxs("div",{ref:t,className:"min-h-screen p-8 md:p-12 lg:p-16 flex flex-col justify-center space-y-8",children:[$.jsxs("div",{className:"mb-2 pt-16 md:pt-0",children:[$.jsx("h2",{className:"text-3xl md:text-5xl font-bold tracking-tight text-white mb-4",children:"Selected Work"}),$.jsx("p",{className:"text-gray-400 max-w-md",children:"Deep dives into machine learning architectures, robotics, and data-driven intelligence."})]}),$.jsxs("div",{onClick:()=>window.open("https://github.com/shrudaysimha/RENEWABLE-ENERGY-POWERED-VEHICLE","_blank"),className:"group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors duration-300 cursor-pointer",children:[$.jsxs("div",{className:"flex justify-between items-start mb-4",children:[$.jsx("div",{className:"px-3 py-1 bg-orange-500/20 text-orange-300 rounded-full text-xs font-mono border border-orange-500/30",children:"Robotics / IoT"}),$.jsxs("div",{className:"flex items-center gap-2",children:[$.jsx("span",{className:"text-gray-500 text-xs font-mono",children:"2025"}),$.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"text-gray-500 group-hover:text-orange-400 transition-colors",children:[$.jsx("path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"}),$.jsx("polyline",{points:"15 3 21 3 21 9"}),$.jsx("line",{x1:"10",y1:"14",x2:"21",y2:"3"})]})]})]}),$.jsx("h3",{className:"text-2xl text-gray-100 font-semibold mb-2 group-hover:text-orange-400 transition-colors",children:"Eco-Nav Autonomous Vehicle"}),$.jsx("p",{className:"text-gray-400 text-sm leading-relaxed mb-4",children:"A renewable energy-powered autonomous vehicle featuring real-time obstacle avoidance. Integrated solar charging with ultrasonic sensor arrays for continuous, safe navigation."}),$.jsxs("div",{className:"flex items-center gap-2 mt-2",children:[$.jsx("div",{className:"w-full h-1 bg-gray-800 rounded-full overflow-hidden flex-1",children:$.jsx("div",{className:"w-1/2 h-full bg-orange-500/50"})}),$.jsx("span",{className:"text-[10px] text-orange-400 font-mono",children:"SOLAR"})]})]})]})})]})},KC=({onBack:o})=>{const t=Te.useRef(null);return Te.useLayoutEffect(()=>{let n=Mn.context(()=>{Mn.from(".animate-item",{y:40,opacity:0,duration:1,stagger:.1,ease:"power3.out",delay:.1})},t);return()=>n.revert()},[]),$.jsxs($.Fragment,{children:[$.jsx("style",{children:`
      ...
      `}),$.jsx("div",{ref:t,className:"fixed inset-0 w-full h-screen flex z-30 pointer-events-none",children:$.jsxs("div",{className:"w-full lg:w-[65%] h-full bg-gradient-to-r from-[#0f0f0f] via-[#0f0f0f]/95 to-transparent pointer-events-auto overflow-y-auto hide-scrollbar relative z-10 px-[8vw] py-24 pb-32",children:[$.jsx("button",{onClick:o,className:"fixed top-8 left-[8vw] z-50 text-xs tracking-[0.2em] uppercase hover:text-[#F4A261] transition-colors border border-white/20 bg-[#0f0f0f]/50 backdrop-blur-md px-6 py-2 rounded-full text-white",children:"< Back"}),$.jsxs("div",{className:"max-w-2xl mt-8 pr-8",children:[$.jsx("p",{className:"animate-item text-[#F4A261] mb-4 tracking-[0.2em] uppercase font-bold text-xs",children:"— Introduction"}),$.jsxs("h1",{className:"animate-item text-5xl md:text-[5rem] font-extrabold leading-[1.05] mb-8 text-white tracking-tight",children:["AI & Data ",$.jsx("br",{}),"Science."]}),$.jsx("p",{className:"animate-item text-lg text-[#9CA3AF] max-w-[90%] leading-relaxed font-light mb-12",children:"I’m a first-year AI & Data Science undergraduate focused on building strong foundations in programming, mathematics, and applied AI. I actively work on machine learning, data science, and early-stage generative AI projects, with an emphasis on understanding concepts deeply and applying them through hands-on implementation."}),$.jsxs("div",{className:"animate-item mb-14",children:[$.jsx("h3",{className:"text-xl font-bold text-white mb-6 tracking-wide",children:"Currently Learning"}),$.jsxs("ul",{className:"space-y-4 text-[#9CA3AF]",children:[$.jsxs("li",{className:"flex items-start",children:[$.jsx("span",{className:"text-[#F4A261] mr-3",children:"▹"}),$.jsx("span",{children:"Python, C/C++, Data Structures & Algorithms"})]}),$.jsxs("li",{className:"flex items-start",children:[$.jsx("span",{className:"text-[#F4A261] mr-3",children:"▹"}),$.jsx("span",{children:"Statistics, Linear Algebra, Probability"})]}),$.jsxs("li",{className:"flex items-start",children:[$.jsx("span",{className:"text-[#F4A261] mr-3",children:"▹"}),$.jsx("span",{children:"Machine Learning, Deep Learning fundamentals"})]}),$.jsxs("li",{className:"flex items-start",children:[$.jsx("span",{className:"text-[#F4A261] mr-3",children:"▹"}),$.jsx("span",{children:"Generative AI, LLMs, and RAG systems"})]})]})]}),$.jsxs("div",{className:"animate-item mb-14 border-l-2 border-[#F4A261] pl-6 py-2",children:[$.jsx("h3",{className:"text-sm uppercase tracking-widest text-gray-500 font-semibold mb-2",children:"Current Project"}),$.jsx("p",{className:"text-xl text-white font-medium",children:"Renewable Energy Powered Vehicle"}),$.jsx("p",{className:"text-[#9CA3AF] text-sm mt-1",children:"(Solar and Wind integrated)"})]}),$.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 mb-16",children:[$.jsxs("div",{className:"animate-item bg-[#1A1A1A] p-8 text-white border border-white/5 rounded-lg transition-transform hover:-translate-y-1 duration-300 shadow-lg",children:[$.jsx("svg",{className:"w-8 h-8 mb-5 text-gray-400",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:$.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"})}),$.jsx("h3",{className:"text-xl font-bold mb-3",children:"Looking to Collaborate"}),$.jsx("p",{className:"text-gray-400 text-sm leading-relaxed",children:"Intermediate AI / ML / Data Science projects, and research-oriented or problem-driven tech initiatives."})]}),$.jsxs("div",{className:"animate-item bg-[#F4A261] p-8 text-[#1A1A1A] rounded-lg transition-transform hover:-translate-y-1 duration-300 shadow-lg",children:[$.jsx("svg",{className:"w-8 h-8 mb-5",fill:"currentColor",viewBox:"0 0 24 24",children:$.jsx("path",{d:"M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z"})}),$.jsx("h3",{className:"text-xl font-bold mb-3",children:"Seeking Opportunities"}),$.jsx("p",{className:"font-medium opacity-90 text-sm leading-relaxed",children:"Internships where I can learn, build, and contribute meaningfully to real-world challenges."})]})]}),$.jsxs("div",{className:"animate-item border-t border-white/10 pt-10",children:[$.jsx("p",{className:"text-xl text-white font-medium italic mb-6",children:'"I enjoy turning simple ideas into practical prototypes and improving my thinking through continuous learning and experimentation."'}),$.jsxs("a",{href:"mailto:shrudaysimha@gmail.com",className:"inline-flex items-center text-[#F4A261] hover:text-white transition-colors font-bold tracking-wide",children:["Mail: shrudaysimha@gmail.com",$.jsx("svg",{className:"w-5 h-5 ml-2",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:$.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:"2",d:"M14 5l7 7m0 0l-7 7m7-7H3"})})]})]})]})]})})]})},QC=({onBack:o})=>{const t=Te.useRef(null),n=Te.useRef(null),a=Te.useRef(null),[s,l]=Te.useState(!1);Te.useEffect(()=>{const d=Mn.timeline({defaults:{ease:"power3.out"}});t.current&&d.fromTo(t.current,{opacity:0},{opacity:.15,duration:1.5}),n.current&&d.fromTo(n.current.children,{y:50,opacity:0},{y:0,opacity:1,stagger:.15,duration:1},"-=1.0"),a.current&&d.fromTo(a.current,{opacity:0,y:-20},{opacity:1,y:0,duration:.6},"-=0.6")},[]);const c=()=>{try{const d=window.AudioContext||window.webkitAudioContext;if(!d)return;const _=new d,g=_.createOscillator(),v=_.createGain();g.connect(v),v.connect(_.destination),g.type="sine",g.frequency.setValueAtTime(800,_.currentTime),g.frequency.exponentialRampToValueAtTime(1200,_.currentTime+.1),v.gain.setValueAtTime(.05,_.currentTime),v.gain.exponentialRampToValueAtTime(.001,_.currentTime+.1),g.start(),g.stop(_.currentTime+.1)}catch{}},f=d=>{d.preventDefault(),!s&&(navigator.clipboard.writeText("shrudaysimha@gmail.com"),l(!0),c(),setTimeout(()=>{l(!1)},2e3))},p=[{label:"LINKEDIN",sub:"NETWORK",href:"https://linkedin.com",icon:$.jsxs("svg",{className:"w-8 h-8 text-white",fill:"none",viewBox:"0 0 24 24",children:[$.jsx("path",{stroke:"currentColor",strokeWidth:"1.5",d:"M4 4h4v4H4zM4 16h4v4H4zM16 4h4v4h-4zM16 16h4v4h-4z"}),$.jsx("path",{stroke:"currentColor",strokeWidth:"1.5",d:"M8 6h8M6 8v8M18 8v8M8 18h8",strokeOpacity:"0.5"})]})},{label:"GITHUB",sub:"REPOSITORIES",href:"https://github.com/shrudaysimha",icon:$.jsxs("svg",{className:"w-8 h-8 text-white",fill:"none",viewBox:"0 0 24 24",children:[$.jsx("path",{stroke:"currentColor",strokeWidth:"1.5",d:"M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z",clipPath:"inset(50% 0 0 0)"}),$.jsx("rect",{x:"4",y:"14",width:"6",height:"6",stroke:"currentColor",strokeWidth:"1.5"}),$.jsx("rect",{x:"14",y:"14",width:"6",height:"6",stroke:"currentColor",strokeWidth:"1.5"}),$.jsx("path",{d:"M12 4v8M7 14l5-4 5 4",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"square"})]})},{label:"EMAIL",sub:"CONTACT",href:"mailto:shrudaysimha@gmail.com",isEmail:!0,icon:$.jsxs("svg",{className:"w-8 h-8 text-white",fill:"none",viewBox:"0 0 24 24",children:[$.jsx("path",{stroke:"currentColor",strokeWidth:"1.5",d:"M2 6h20v12H2z"}),$.jsx("path",{stroke:"currentColor",strokeWidth:"1.5",d:"M2 6l10 7 10-7"}),$.jsx("circle",{cx:"12",cy:"13",r:"2",stroke:"currentColor",strokeWidth:"1.5",fill:"none"})]})}];return $.jsxs("div",{className:"fixed inset-0 z-50 flex flex-col items-center justify-center overflow-hidden",children:[$.jsx("div",{ref:t,className:"absolute inset-0 pointer-events-none",style:{backgroundImage:`linear-gradient(rgba(6, 182, 212, 0.3) 1px, transparent 1px),
                                      linear-gradient(90deg, rgba(6, 182, 212, 0.3) 1px, transparent 1px)`,backgroundSize:"40px 40px",maskImage:"radial-gradient(circle at center, black 40%, transparent 80%)"}}),$.jsx("div",{className:"fixed top-6 right-6 z-50",children:$.jsxs("button",{ref:a,onClick:o,className:"group flex items-center gap-2 text-cyan-400 hover:text-cyan-200 transition-colors duration-300 text-sm font-mono uppercase tracking-widest px-4 py-2 rounded-full border border-cyan-500/20 bg-black/40 backdrop-blur-md hover:bg-cyan-900/20",children:[$.jsx("span",{className:"text-xs mr-1",children:"[ESC]"}),"Abort"]})}),$.jsxs("div",{ref:n,className:"flex flex-col gap-4 w-full px-4 md:items-center",children:[$.jsxs("div",{className:"text-center mb-8",children:[$.jsx("h2",{className:"text-sm font-mono text-cyan-500 tracking-[0.3em] uppercase mb-2",children:"System // Connect"}),$.jsx("div",{className:"w-1 h-8 bg-gradient-to-b from-cyan-500 to-transparent mx-auto"})]}),p.map((d,_)=>{const g=d.isEmail&&s;return $.jsxs("a",{href:d.isEmail?"#":d.href,onClick:d.isEmail?f:void 0,target:d.isEmail?void 0:"_blank",rel:d.isEmail?void 0:"noopener noreferrer",className:`group relative w-full md:w-[600px] h-24 flex items-center bg-white/5 backdrop-blur-lg border border-white/10 hover:border-[#00f3ff] transition-all duration-500 ease-out hover:translate-x-5 overflow-hidden rounded-sm ${g?"border-green-500/50":""}`,children:[$.jsx("div",{className:"absolute inset-0 bg-[#00f3ff]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"}),$.jsx("div",{className:"absolute left-0 w-12 h-full flex items-center justify-center -translate-x-full group-hover:translate-x-0 transition-transform duration-300 ease-out",children:$.jsx("svg",{className:`w-6 h-6 ${g?"text-green-400":"text-[#00f3ff]"}`,fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",children:$.jsx("path",{strokeLinecap:"square",strokeLinejoin:"miter",strokeWidth:"2",d:"M9 5l7 7-7 7"})})}),$.jsxs("div",{className:"flex-1 flex items-center justify-between px-8 pl-8 group-hover:pl-16 transition-all duration-300",children:[$.jsxs("div",{className:"flex flex-col",children:[$.jsx("span",{className:`text-2xl md:text-3xl font-mono font-light transition-colors duration-300 tracking-tight ${g?"text-green-400 font-bold":"text-white group-hover:text-[#00f3ff]"}`,children:g?"COPIED TO CLIPBOARD":d.label}),$.jsxs("span",{className:`text-[10px] font-mono tracking-[0.2em] uppercase ${g?"text-green-400/60":"text-gray-500 group-hover:text-[#00f3ff]/60"}`,children:["// ",g?"shrudaysimha@gmail.com":d.sub]})]}),$.jsx("div",{className:`w-12 h-12 flex items-center justify-center opacity-60 group-hover:opacity-100 group-hover:scale-110 transition-all duration-500 ${g?"text-green-400 opacity-100":""}`,children:d.icon})]}),$.jsx("div",{className:`absolute top-0 left-0 w-2 h-2 border-t border-l border-white/30 group-hover:border-[#00f3ff] ${g?"border-green-400":""}`}),$.jsx("div",{className:`absolute bottom-0 right-0 w-2 h-2 border-b border-r border-white/30 group-hover:border-[#00f3ff] ${g?"border-green-400":""}`})]},_)})]})]})},JC=({isDark:o})=>{const t=Te.useRef(null);return Te.useEffect(()=>{const n=s=>{Mn.to(t.current,{x:s.clientX,y:s.clientY,duration:.2,ease:"power2.out"})},a=s=>{const l=s.target;l.tagName.toLowerCase()==="button"||l.tagName.toLowerCase()==="a"||l.closest("button")||l.closest("a")||l.classList.contains("interactive")?Mn.to(t.current,{scale:3,opacity:.4,duration:.2}):Mn.to(t.current,{scale:1,opacity:.8,duration:.2})};return window.addEventListener("mousemove",n),window.addEventListener("mouseover",a),()=>{window.removeEventListener("mousemove",n),window.removeEventListener("mouseover",a)}},[]),$.jsx("div",{ref:t,className:`
        hidden md:block 
        fixed top-0 left-0 w-6 h-6 rounded-full pointer-events-none z-[9999] 
        transform -translate-x-1/2 -translate-y-1/2
        transition-colors duration-500 ease-in-out
        ${o?"bg-[#f4f4f0]":"bg-gray-800"}
      `})},$C=()=>{const[o,t]=Te.useState("home"),n=Te.useRef(null),a=o==="projects"?"work":o==="about"?"about":o==="contact"?"contact":"home",s=o!=="home";return Te.useEffect(()=>{if(n.current){let l="#f4f4f0";o==="contact"?l="#0b0f19":o!=="home"&&(l="#0f0f0f"),Mn.to(n.current,{backgroundColor:l,duration:1.5,ease:"power2.inOut",delay:o!=="home"?.2:0})}},[o]),$.jsxs("main",{ref:n,className:"relative min-h-screen w-full bg-paper text-dark-grey font-sans selection:bg-blue-200 selection:text-blue-900 overflow-x-hidden transition-colors",children:[$.jsx(jC,{}),$.jsx(JC,{isDark:s}),$.jsx(JS,{activeSection:a}),$.jsxs("div",{className:"relative z-20",children:[$.jsx(LE,{isHidden:o!=="home",onNavigate:t}),$.jsx("div",{className:o!=="home"?"pointer-events-none":"",children:$.jsx(YC,{isExploring:o!=="home",onExplore:()=>t("projects"),activeSection:o==="projects"?"work":o})}),o==="projects"&&$.jsx(ZC,{onBack:()=>t("home")}),o==="about"&&$.jsx(KC,{onBack:()=>t("home")}),o==="contact"&&$.jsx(QC,{onBack:()=>t("home")})]})]})};pb.createRoot(document.getElementById("root")).render($.jsx(sb.StrictMode,{children:$.jsx($C,{})}));
